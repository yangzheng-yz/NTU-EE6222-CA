...
class FlowIter(data.Dataset):
    ...
    def __init__(self,
        ...
        self.video_prefix_x = video_prefix
        self.video_prefix_y = video_prefix
    ...
    def getitem_from_raw_video(self, index):
        ...
        video_path_x = os.path.join(self.video_prefix_x, vid_subpath, 'u')
        video_path_y = os.path.join(self.video_prefix_y, vid_subpath, 'v')
    ...
    def _get_video_list(self,
        ...
        with open(txt_list) as f:
            ...
            for i, line in enumerate(lines):
                ...
                video_path_x = os.path.join(video_prefix_x, video_subpath, 'u')
