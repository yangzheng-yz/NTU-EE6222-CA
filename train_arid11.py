...
parser.add_argument('--val-frame-interval', type=int, default=2,
                    help="define the sampling interval between frames.")
parser.add_argument('--save-frequency', type=int, default=3,
                    help="define the sampling interval between frames.")
...
parser.add_argument('--brighten_method', type=str, 
                    default=None,
                    help="lime/ying_caip")
...
if __name__ == "__main__":
    ...
    dataset_cfg = dataset.get_config(name=args.dataset) # a dict include the classes number
